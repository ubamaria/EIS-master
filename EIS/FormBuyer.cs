        ...
        private void toolStripButtonDelete_Click(object sender, EventArgs e)
        {
           ...
           ";New=False;Version=3";
            ...
            String selectCommand = "delete from JournalEntries where IdJournalOfOperations = " +
                    ...
                    "(select IdRequest from Request where IdBuyer = '" + valueId + "'))";
            changeValue(ConnectionString, selectCommand);
            ...
            selectCommand = "delete from TablePartOperation where IdRequest = " +
                "(select IdRequest from Request where IdBuyer = '" + valueId + "')";
            changeValue(ConnectionString, selectCommand);
            selectCommand = "delete from RequestMaterial where IdRequest = " +
                "(select IdRequest from Request where IdBuyer = '" + valueId + "')";
            changeValue(ConnectionString, selectCommand);
            selectCommand = "delete from Request where IdBuyer = '" + valueId + "'";
            changeValue(ConnectionString, selectCommand);
            selectCommand = "delete from Buyer where IdBuyer=" + valueId;
            changeValue(ConnectionString, selectCommand);
            //обновление dataGridView1
            selectCommand = "select * from Buyer";
            refreshForm(ConnectionString, selectCommand);
